...
SCHEMES: dict[str, dict[str, Any]] = {
    "pms": {
        ...
        "lead_days": 30,
        "claim_days_after": 30,
        "apply_rule": "Since Sep 2026 the scheme runs on the new PMS portal (pms.dcmsme.gov.in): organisers file fair approvals there for events from October 2026 onwards and each approved fair appears under 'View All Events' with its own MSE application window (sign in with the Udyam number + mobile). First check the fair is listed there (older editions were on my.msme.gov.in → Trade Fairs Domestic). If it is: apply inside the fair's window, at least 30 days before the show, and submit the claim with stall-rent invoice, payment proof and photos within 30 days after it ends. If it is not: the organiser / industry association must get the fair approved by DC-MSME — ask them, and re-check the portal every 3 days.",
        "link": "https://pms.dcmsme.gov.in/view-all-event",
        "status": "confirmed",
        "fair_must_be_listed": True,
        "sources": ["https://pms.dcmsme.gov.in/", "https://pms.dcmsme.gov.in/view-all-event", "https://my.msme.gov.in/MyMsme/Reg/COM_Fair.aspx", "https://en.vikaspedia.in/viewcontent/schemesall/schemes-for-entrepreneurs/procurement-and-marketing-support/procurement-marketing-support-to-msmes?lgn=en", "https://msme1connect.up.gov.in/Home/SchemesList/32", "https://www.stonemart-india.in/pms-scheme", "https://www.scribd.com/document/743420419/OM-PMS-Scheme-Guidelines", "https://ramp.msme.gov.in/ramp/sites/default/files/2026-05/PMS_Scheme_Guidelines_0.pdf", "https://schemesmsme.com/procurement-and-marketing-support-pms-msme-2025-26/", "https://msme.gov.in/1-marketing-promotion-schemes"],
    },
    "telangana": {
    ...
    "ic": {
        ...
        "lead_days": 120,
        "claim_days_after": 30,
        "apply_rule": "The association applies in the ministry's call for proposals before the event. The last call (events 1 Jun – 30 Sep 2026) closed on 5 May 2026 17:30; no call for Oct 2026 – Mar 2027 events was visible on 19 Sep 2026 — the 3-day follow-up keeps watching ic.msme.gov.in.",
