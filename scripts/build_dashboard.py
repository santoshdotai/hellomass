...
def build() -> dict:
    ...
    for e in evs:
        ...
        rows.append({**{k: e[k] for k in ("id", "name", "edition", "category", "icp", "start", "end", "city", "venue", "venue_area", "organiser", "website", "mode", "tentative", "footfall_history", "expected", "why", "stall", "sectors", "circuit", "purpose", "attend") if k in e},
